  ...
  return (
    <div id="canvas-container">
      ...
      >
        ...
        <Effects/>
        <ARAnchor target={1} onAnchorFound={onAnchorFound}>
          <WE2002Model scale={0.3} position={[0.3,-0.5,0]} />
        </ARAnchor>
      ...
      <div id="text-display">
        <Typewriter isMuted={isMuted} onClick={onClick} delay={15} text={`${inputs[index]} [${index+1}/${inputs.length}]`}/>
      </div>
    </div>
  )
}
